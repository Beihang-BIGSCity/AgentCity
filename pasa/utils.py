...
GOOGLE_KEY = "1163e00449dce84869048401eccca059865553ff"
arxiv_client = arxiv.Client(delay_seconds=0.05)
id2paper = json.load(open(DATA_DIR / "paper_database/id2paper.json"))
paper_db = zipfile.ZipFile(DATA_DIR / "paper_database/cs_paper_2nd.zip", "r")
